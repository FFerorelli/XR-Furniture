    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 ShadowReceiverFragment(const Varyings input) : SV_Target {
                ...
                half4 fragmentOutput = half4(color, alpha + (lightAlpha * _HighlightOpacity));

                 // Apply occlusion calculation
                META_DEPTH_OCCLUDE_OUTPUT_PREMULTIPLY(input, fragmentOutput, 0.0);
